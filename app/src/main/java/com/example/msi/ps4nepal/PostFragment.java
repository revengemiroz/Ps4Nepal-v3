...
*/
    ...
    public class BackgroundImageResize extends AsyncTask<Uri,Integer,byte[]>{
        ...
        protected byte[] doInBackground(Uri... params) {
            ...
            byte[] bytes=null;
            Log.d(TAG,"doInBackground: megabytes before compressing: "+mBitmap.getByteCount()/1000000);
    ...
    private void executeUploadTask(){
        ...
        final StorageReference storageReference= FirebaseStorage.getInstance().getReference()
                .child("post/users" + FirebaseAuth.getInstance().getCurrentUser().getUid() + "/" +postId + "/post_image");
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                refrence.child(getString(R.string.node_posts))
                        .child(postId)
                        .setValue(post);
                resetFields();
            }
